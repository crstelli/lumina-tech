...
function Card({ children, label, icon: Icon }: Props) {
  return (
    <div className="flex flex-col w-full items-center text-center shadow-lg py-6 border border-gray-200 rounded-lg px-6">
      ...
      <p className="mt-4 italic text-gray-600">{label}</p>
    </div>
  );
}
