...
export default function page() {
  return (
    <Container>
      ...
      <form className="mt-20 px-4 py-6 rounded-md shadow-[0_1px_20px_rgba(0,0,0,0.15)] grid grid-cols-2 w-[90%] gap-y-6 gap-x-4 max-w-[700px]">
        <h2 className="col-span-2 mb-10 text-center text-2xl font-bold">
        ...
        <textarea
          maxLength={1000}
          rows={5}
          className="col-span-2 resize-none border border-gray-300 px-4 py-2 rounded-md focus:outline-none focus:ring-1 focus:shadow-2xl focus:shadow-primary-500/50 focus:border-primary-500 focus:ring-primary-500"
      ...
      <div className="max-w-[800px] mt-40 border border-gray-200 rounded-md overflow-hidden w-full aspect-video">
        <iframe
      ...
      <h4 className="mt-30 italic text-4xl pb-3 text-gray-700">
